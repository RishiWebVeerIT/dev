...
@section('section')
    ...
    <div class="d-flex">
        ...
        <a href="{{route('resident.tax.potrait.yearly.reciept',[$data->id, $otdetails->year])}}" role="banner" class="btn btn-light left-20">Potrait Reciept</a>
        <a href="{{route('resident.tax.yearly.main.reciept',[$data->id, $otdetails->year])}}" role="banner" class="btn btn-light left-20">Main Reciept</a>
    </div>
@endsection

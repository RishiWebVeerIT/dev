...
@section('section')
    ...
    <div class="d-flex">
        ...
        <a href="{{route('resident.tax.yearly.landscape.reciept',[$data->id, $otherTax->year])}}" role="button" class="btn btn-light left-20">Landscape Reciept</a>
        <a href="{{route('resident.tax.potrait.yearly.reciept',[$data->id, $otherTax->year])}}" role="banner" class="btn btn-light left-20">Potrait Reciept</a>
    </div>
